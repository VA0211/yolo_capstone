...
class LADH(nn.Module):
    ...
    def forward(self, x):
        ...
        avg_out = avg_out.view(avg_out.size(0), -1, 1, 1)
        out = out1 * torch.sigmoid(avg_out) + out2
        return out
    
# Official code https://github.com/JierunChen/FasterNet/blob/master/models/fasternet.py
